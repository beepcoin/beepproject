...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("BEEP");
    case mBTC: return QString("mBEEP");
    case uBTC: return QString::fromUtf8("μBEEP");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("BeepCoins"));
    case mBTC: return QString(QObject::tr("Milli-BeepCoins (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-BeepCoins (1 / 1,000,000)"));
    default: return QString("???");
    }
}
